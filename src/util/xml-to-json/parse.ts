...
export default async  (url: string, config?: AxiosRequestConfig) => {
  ...
  const mediaItems: string[] = ['content:encoded', 'podcast:transcript', 'itunes:summary', 'itunes:author', 'itunes:explicit', 'itunes:duration', 'itunes:season', 'itunes:episode', 'itunes:episodeType', 'itunes:image'];
